...
public class ARActivityTesting {
    ...
    @Test
    public void deltaAngleTest1() throws Exception {
        ARActivity sampleActivity = new ARActivity();
    ...
    @Test
    public void deltaAngleTest2() throws Exception {
        ARActivity sampleActivity = new ARActivity();
        ...
        assertEquals((174.04891184209873-90),sampleActivity.calculatedAngle(90,location1.getLatitude(), location1.getLongitude(), location2.getLatitude(), location2.getLongitude()), 3);
    }

    @Test
    public void deltaAngleTest3() throws Exception {
        ARActivity sampleActivity = new ARActivity();
        ...
        assertEquals((159.624-90),sampleActivity.calculatedAngle(90,location1.getLatitude(), location1.getLongitude(), location2.getLatitude(), location2.getLongitude()), 3);
    }

    @Test
    public void deltaAngleTest4() throws Exception {
        ARActivity sampleActivity = new ARActivity();
        ...
        assertEquals((96.51-90),sampleActivity.calculatedAngle(90,location1.getLatitude(), location1.getLongitude(), location2.getLatitude(), location2.getLongitude()), 3);
    }
